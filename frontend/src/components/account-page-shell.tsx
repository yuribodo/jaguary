      ...
      <Sidebar className="border-sidebar-border" collapsible="icon">
        <SidebarHeader className="gap-3 border-b border-sidebar-border p-3">
          <div className="flex h-10 items-center gap-2 px-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0">
            ...
            <SidebarTrigger aria-label="Collapse sidebar" className="ml-auto size-9 group-data-[collapsible=icon]:ml-0" />
          </div>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton render={<Link href="/" />} className="h-11 border border-sidebar-border bg-background px-3 shadow-none" tooltip="Back to conversation">
                <><ArrowLeftIcon /><span>Back to conversation</span></>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        </SidebarHeader>
        ...
        <SidebarFooter className="border-t border-sidebar-border p-3">
          <div className="flex min-h-12 items-center gap-3 rounded-lg px-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0">
            ...
            <span className="grid text-xs group-data-[collapsible=icon]:hidden"><strong>TravelBot</strong><small className="text-[10px] text-sidebar-foreground/60">Verified identity</small></span>
          </div>
        </SidebarFooter>
        <SidebarRail />
      </Sidebar>
