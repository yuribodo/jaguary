...
import {
  ...
  identifierSchema,
  moneySchema,
  purchaseDisputeEvidenceChecksSchema,
  purchaseDisputeFinancialOutcomeSchema,
  purchaseDisputeLiablePartySchema,
  purchaseDisputeReasonSchema,
  purchaseDisputeResolutionCodeSchema,
  purchaseDisputeVerdictSchema,
  reasonCodeSchema,
  sha256Schema,
  utcRfc3339Schema,
...
export const ledgerPayloadSchemas = {
  ...
  "dispute.evidence_evaluated": z.object({
    dispute_id: identifierSchema,
    mandate_id: identifierSchema,
    agent_id: identifierSchema,
    checkout_id: identifierSchema,
