...
test("Postman collection is valid JSON with executable current routes", async () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      "Create Marta demo session",
      "Read principal session",
      "Start TravelBot attestation",
      "Refresh rotated principal session",
      "Read TravelBot assurance",
      "Issue Bound Agent Passport",
      "Read Bound Passport JWKS",
      ...
      "Reject completion without approved payment",
      "Read VuelaYa order",
      ...
      "Read missing receipt dispute",
      "Open dispute for missing receipt",
      "Read missing dispute",
      "Create conversation",
      "Read conversation",
